...
public class ExtentManager extends pages.BasePage{
	...
	public static String fileName;
	    ...
	    public static ExtentReports createInstance(String fileName) {
	        ...
	        extent.setSystemInfo("Tester", "Dharm");
		...
		public static void captureScreenshot() throws IOException {
			...
			File screeshot = ((TakesScreenshot)  pages.BasePage.driver).getScreenshotAs(OutputType.FILE);
